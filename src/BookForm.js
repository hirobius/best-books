...
class BookForm extends React.Component {
  ...
  fetchUserData = () => {
    ...
    axios.get(process.env.REACT_APP_BACKEND_URL || 'http://localhost:3002/users'/this.props.email)
    .then(serverResponse => {
  ...
  handleCreateBook = (e) => {
    ...
    axios.post(process.env.REACT_APP_BACKEND_URL || 'http://localhost:3002/books', {
